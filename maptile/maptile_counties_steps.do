...
* if above files are not available, check my github repo, "https://github.com/cmaene/Stata/maptile/" instead
...
cd /home/cmaene/Documents/Stata/maptile
...
* also make sure to sort your data
sort county
